...
public class Lecteur implements Serializable
{
        ...
        public void affecterEmprunt(Emprunt emprunt)
	{
        ...
        /**
         * Supprime l'emprunt passé en paramètres de l'HashSet d'emprunts du lecteur
         */
	 ...
	 */
        ...
        {
            System.out.println("Lecteur n°" + this.getNumLecteur());
	...
	public void afficherEmpruntsLecteur()
	{
	    ...
	    System.out.print(Color.BLUE + "Lecteur n°" + getNumLecteur());
	    System.out.println(", " + getNom() + " " + getPrenom() + Color.RESET);
	    System.out.println(Color.BLUE + "" + emprunts.size() + " emprunts en cours\n" + Color.RESET);
